...
public class EditarSala extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        salvarSala = new javax.swing.JButton();
        ...
        salvarSala.setText("Salvar Sala");
        salvarSala.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                salvarSalaMouseClicked(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(salvarSala, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(5, 5, 5)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(numColunas, javax.swing.GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE)
                            .addComponent(numero)
    ...
    private void salvarSalaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_salvarSalaMouseClicked
        if (verificaSala()) {
            ...
            salaDados.deletaDados(index);
            salaDados.adicionaDados(index,s);
    ...
    }//GEN-LAST:event_salvarSalaMouseClicked
    ...
    private void excluirSalaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_excluirSalaMouseClicked
        if(JOptionPane.showConfirmDialog(null, "Deseja realmente excluir a sala?","Exclusão", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION){
            ...
            JOptionPane.showMessageDialog(null, "Sala excluída.","Info",1);
    ...
    public void preenche(){
        numero.setText(Integer.toString(s.getNumero()));
        assentos.setText(Integer.toString(s.getNumAsentos()));
        descricao.setText(s.getDescricao());
        numColunas.setText(Integer.toString(s.getNumColunas()));
    }
    ...
    private javax.swing.JButton salvarSala;
